...
for i in range(20000):
	...
	if i % 100 == 0:
		eval_accuracy = sess.run(accuracy, feed_dict={x: batch_xs, y_: batch_ys, keep_prob: 1.0})
		print("Step " + str(i) + " accuracy " + str(eval_accuracy))
